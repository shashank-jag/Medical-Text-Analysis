...
def addPunct(counter):
	#.......................punct.	
	# ind = counter+1
	# while ind<len(file) and (file[ind] == ' ' or file[ind] == '.' or file[ind] == ',' or file[counter] == '/n'):
	# 	ind+=1
	# 	# print(file[ind],'*')
	# if ind != counter:
	# 	ind-=1
...
for line in entries:
	...
	#...........unhandled .............................
	if pres_entry[-1] == '0':
		if pres_entry[0] == "PRN" or pres_entry[0] == "p.r.n." or pres_entry[0] == "morning" or pres_entry[0] == "times" or pres_entry[0] == "day" or pres_entry[0] == "once" or pres_entry[0] == "days" or pres_entry[0] == "minutes" or pres_entry[0] == "a.m." or pres_entry[0] == "p.m." or pres_entry[0] == "once"or pres_entry[0] == "every" :
			pres_entry[-1] = "frequency"
		else :
			continue
	word = pres_entry[0]
